#include "auto_lift/auto_lift.hpp"
 ...
 : Node("agx_lift_node")
{
  ...
  <LIFT_REQUEST>(
    ...
    1,
    std::bind(&auto_lift::lift_state_callback, this, std::placeholders::_1)
  );
}

  void auto_lift::lift_state_callback(LIFT_REQUEST_Share msg)
  {
...
int main(int argc, char ** argv)
{
  ...
  std::shared_ptr<auto_lift> agx_lift_node = std::make_shared<auto_lift>();
